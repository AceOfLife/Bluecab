package com.drivequeen.driver.Helper;
...
public class URLHelper {
   ...
   /* public static final String base = "http://omninos.com/golimo/" +
    ...
    public static final String base = "http://feedball.co/bluecab/dashboard/";
    ...
    public static String HELP_URL = "http://omninos.com/golimo/";
